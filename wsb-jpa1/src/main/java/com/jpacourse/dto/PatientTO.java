...
public class PatientTO {
    ...
    private List<VisitInPatientTO> visits;
    ...
    public List<VisitInPatientTO> getVisits() { return visits; }
    public void setVisits(List<VisitInPatientTO> visits) { this.visits = visits; }
}
